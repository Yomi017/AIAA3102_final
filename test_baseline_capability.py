...
from benchmarkTest.general_capability import GeneralCapabilityTester
...
def main():
    ...
    test_configs = {
        'ai': {
            'file': 'benchmark/RAG/test_cases_RAG_AI.txt',
            'name': 'AI 知识库'
        },
        'robomaster': {
            'file': 'benchmark/RAG/test_cases_RoboMaster_RAG.txt',
            'name': 'RoboMaster 知识库'
        },
        'web': {
            'file': 'benchmark/web/test_cases_web.txt',
            'name': 'Web 搜索'
        }
    }
    ...
    try:
        for test_set in args.test_sets:
            ...
            # 运行测试
            tester = GeneralCapabilityTester(baseline, result_dir=f"benchmark_results/baseline/{test_set}")
